...
from loops import  experiment_optimize
#from experiment_loops_axy import  experiment_optimize
...
def parameter_sweep(intervention, k, init, seed=347, guess=False, savedir='categorical_results'):
