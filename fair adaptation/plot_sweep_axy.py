...
def curve_plot(bestof, nsteps, figsize, logscale=False, endstep=2000, confidence=(5, 95)):
...
def all_plot(guess=False, dense=True,
             input_dir='axy_categorical_results', output_dir='camera_ready',
             figsize=(3.6, 2.2)):
